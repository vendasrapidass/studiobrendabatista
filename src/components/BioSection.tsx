      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="relative w-72 h-96 md:w-80 md:h-[450px]">
            ...
            {/* Main Image */}
            <img
              src="https://i.imgur.com/MmSADCD.jpeg"
              alt="Brenda Batista - Lash Designer"
        ...
        >
          ...
          <div className="glass p-6 md:p-8 rounded-2xl border border-border/60 card-shadow space-y-4">
            <p className="text-lg text-foreground/90 leading-relaxed font-medium">
              Sou Brenda Batista, Lash designer e Design sobrancelha especializada.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Meu propósito é unir beleza, delicadeza e bem-estar para valorizar a essência de cada cliente, oferecendo resultados naturais, elegantes e feitos com muito cuidado.
            </p>
          </div>
        </motion.div>
      </div>
